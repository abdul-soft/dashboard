<div class="form-group {{ $errors->has('dashboard_id') ? 'has-error' : ''}}">
    {!! Form::label('dashboard_id', 'Dashboard Id', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
        {!! Form::number('dashboard_id', null, ['class' => 'form-control']) !!}
    ...
    <div class="col-md-6">
        {!! Form::textarea('file_url', null, ['class' => 'form-control']) !!}
